...
const startGame = () => {
    container.classList.remove("hide_game");
...
boxes.forEach((box) => {
    box.addEventListener("click", () =>{
        ...
        if(isWinner){
            showWinner(turnX ? player2.value : player1.value);
        }
...
const gameDraw = () => {
    ...
    msgContainercontainer.scrollIntoView({ behavior: "smooth" });
    disableBoxes();
};
